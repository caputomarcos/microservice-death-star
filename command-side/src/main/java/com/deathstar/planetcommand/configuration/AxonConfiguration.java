package com.deathstar.planetcommand.configuration;
...
public class AxonConfiguration {
	...
	@Bean
	EventSourcingRepository<PlanetAggregate> planetEventSourcingRepository() {
		EventSourcingRepository<PlanetAggregate> repo = new EventSourcingRepository<PlanetAggregate>(
				PlanetAggregate.class, eventStore());
	 ...
	 */
	@Bean
	AggregateAnnotationCommandHandler<PlanetAggregate> planetAggregateCommandHandler() {
		@SuppressWarnings("deprecation")
		AggregateAnnotationCommandHandler<PlanetAggregate> handler = new AggregateAnnotationCommandHandler<PlanetAggregate>(
				PlanetAggregate.class, planetEventSourcingRepository(), commandBus());
		return handler;
	}
